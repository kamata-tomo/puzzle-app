    ...
    public function show_stages(Request $request)
    {
        ...
        $result = $stages->map(function ($stage) use ($progress) {
            ...
            return [
                ...
                'shuffle_count'=> $stage->shuffle_count,
                'reference_value_1'=> $stage->reference_value_1,
                'reference_value_2'=> $stage->reference_value_2,
                'reference_value_3'=> $stage->reference_value_3,
                'clear'       => $p ? true : false,
